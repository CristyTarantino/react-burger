...
const addIngredient = (state, action) => {
  const addIngredient = { [action.payload.ingredientName]: state.ingredients[action.payload.ingredientName] + 1 }
...
const removeIngredient = (state, action) => {
  const removeIngredient = { [action.payload.ingredientName]: state.ingredients[action.payload.ingredientName] - 1 }
